...
namespace F0.Tests.Assertions
{
	public class NonGenericValueTaskDelegateUnderTestTests
	{
		...
		{
			NonGenericValueTaskDelegateUnderTest assertor = new(SuccessfullyCompleteSynchronously);
		...
		{
			NonGenericValueTaskDelegateUnderTest assertor = new(SuccessfullyCompleteAsynchronously);
		...
		{
			NonGenericValueTaskDelegateUnderTest assertor = new(ThrowSynchronously);
		...
		{
			NonGenericValueTaskDelegateUnderTest assertor = new(ThrowAsynchronously);
