...
{
	public sealed class GenericValueTaskDelegateUnderTest<T>
	{
		private readonly Func<ValueTask<T>> asynchronousMethod;

		internal GenericValueTaskDelegateUnderTest(Func<ValueTask<T>> asynchronousMethod)
		{
